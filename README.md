Los datos del archivo corresponden a 24 accesiones de quinoa nativa del Noroeste Argentino caracterizadas a través de 10 variables cuantitativas y 8 variables
cualitativas. En el identificador de cada accesión se encuentra la indicación de la procedencia del mismo: 
